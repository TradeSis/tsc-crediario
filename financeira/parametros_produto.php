    ...
    <script>
        ...
        function buscar() {
            ...
            $.ajax({
                type: 'POST',
                dataType: 'html',
                url: '<?php echo URLROOT ?>/crediario/database/parametrosproduto.php?operacao=buscar',
                beforeSend: function() {
    ...
    <script>
        $(document).ready(function() {
            $("#inserirForm").submit(function(event) {
                ...
                $.ajax({
                    url: "../database/parametrosproduto.php?operacao=inserir",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $("#alterarForm").submit(function(event) {
                ...
                var formData = new FormData(this);
                $.ajax({
                    url: "../database/parametrosproduto.php?operacao=alterar",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $("#excluirForm").submit(function(event) {
                ...
                var formData = new FormData(this);
                $.ajax({
                    url: "../database/parametrosproduto.php?operacao=excluir",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
