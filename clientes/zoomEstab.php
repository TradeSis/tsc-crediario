...
<script>
    ...
    function buscar(buscaEstab, pagina) {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'html',
            url: "<?php echo URLROOT ?>/crediario/database/crediariocontrato.php?operacao=buscarFiliais",
            beforeSend: function () {
            ...
            success: function (msg) {
                ...
                if (json.status === 400) {
                    ...
                    for (var $i = 0; $i < json.length; $i++) {
                        ...
                        linha = linha + "<tr>";
                        linha = linha + "<td class='ts-click' data-etbcod='" + object.etbcod + "' data-etbnom='" + object.etbnom + "'>" + object.etbcod + "</td>";
                        linha = linha + "<td class='ts-click' data-etbcod='" + object.etbcod + "' data-etbnom='" + object.etbnom + "'>" + object.etbnom + "</td>";
                        linha = linha + "</tr>";
                    }
