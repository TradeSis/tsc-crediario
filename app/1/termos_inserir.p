...
find termos where termos.IDtermo = ttentrada.IDtermo no-lock no-error.
if avail termos
then do:
    create ttsaida.
    ttsaida.tstatus = 400.
    ttsaida.descricaoStatus = "termo ja cadastrado".
...
create ttsaida.
ttsaida.tstatus = 200.
ttsaida.descricaoStatus = "termo criado com sucesso".
hsaida  = temp-table ttsaida:handle.
