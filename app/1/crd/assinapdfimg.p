...
def input param vaux-image-name as char init "idbiometria".
def input param vaux-image as char      init "/admcom/work/filename1.jpg".
...
RUN pdf_new ("Spdf", varqpdf).
            ...
            run pdf_load_image("Spdf",vaux-image-name,vaux-image).
